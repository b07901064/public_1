...
class SpatialSoftmax(nn.Module):
    ...
    def forward(self, feature):
        ...
        #print(feature.size()) #torch.Size([64, 36, 16, 16]) -> torch.Size([64, 128, 7, 15])
        flattened = feature.view(feature.shape[0], feature.shape[1], -1)
        #print(flattened.size()) #torch.Size([64, 36, 6720])
        softmax = F.softmax(flattened, dim=-1)
        #print('softmax dim:', softmax.size()) #torch.Size([64, 36, 256]) -> torch.Size([64, 36, 6720])
